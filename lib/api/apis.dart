...
class APIs {
      ...
      var res = await post(Uri.parse('https://fcm.googleapis.com/fcm/send'),
          headers: {
            ...
            HttpHeaders.authorizationHeader:
                'key=AAAAAGo3W2w:APA91bHJnbGhYVxJK-dLdkMY44rQRaHN6ddDwNaBzgkgSq-ZHGEGyFx7qyYqw8nAldQslMuM-ukUGQ9Yh4faI0sR4_14Yo1jbb5faT74y892hlNgWxOJjqNtXHP6SBtz3VxGqE6yZ3YU'
          },
  ...
  // for adding a user to my_users when first msg is sent
  ...
  static Stream<QuerySnapshot<Map<String, dynamic>>> getUerInfo(
      ChatUser chatUser) {
    return firestore
        .collection('users')
  ...
  static Future<void> sendMessage(
      ChatUser chatUser, String msg, Type type) async {
    // message sendinf time (also used as ID)
    final time = DateTime.now().millisecondsSinceEpoch.toString();
